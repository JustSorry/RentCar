...
using(ApplicationContext db = new ApplicationContext())
{
    ...
    Car vwPoloSedan = new Car { Brand = "Volkswagen", Model = "Polo Sedan", CarBody = "Sedan", YearOfProd = 2017, DriveType = "FWD", CountryOfProd = "Germany", TypeOfEngine = "Petrol", EngineV = 1.6, TypeOfGearbox = "Mechanical", Milleage = 150000, DayPrice = 45.0, WeekPrice = 225.0 };
